...
const OVERLAY_COORDS = {
    1: { // Mode 1: Standard Spoilers
        "top-horizontal-strip": { xStart: 0, xEnd: 50, yStart: 0, yEnd: 11 },
        "left-vertical-strip": { xStart: 0, xEnd: 15, yStart: 11, yEnd: 31 },
        "bottom-wide-strip": { xStart: 10, xEnd: 95, yStart: 79, yEnd: 100 }
    },
    2: { // Mode 2: Night Mode
